...
public class UTF2GBK {
    ...
    public static void main(String[] args){
        String strUtf8 = "我是中国人";
        System.out.println("UTF8: "+ strUtf8);
        String strUcs = UTF2GBK.utf8ToUnicode(strUtf8);
        System.out.println("utf8ToUnicode: "+ strUcs);
        String strGbk = UTF2GBK.Unicode2GBK(strUcs);
        System.out.println("Unicode2GBK: "+ strGbk);
        System.out.println("BGK2UTF8: "+ UTF2GBK.gbk2utf8(strGbk));
